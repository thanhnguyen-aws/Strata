...
def main (args : List String) : IO UInt32 := do
  ...
  | [file] => do
    ...
    let dialects := #[Boogie, C_Simp] -- Add more dialects later
    let ms := Strata.Elab.elabProgram emptyEnv dialects inputCtx
