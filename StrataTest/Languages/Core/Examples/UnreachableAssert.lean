...
Assumptions:
z_false: init_z_2 == false
<label_ite_cond_true: (z == #false)>: if init_z_2 == false then (init_z_2 == false) else true
<label_ite_cond_false: !(z == #false)>: if if init_z_2 == false then false else true then if init_z_2 == false then false else true else true
Obligation:
